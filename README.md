...
* Learn how to use the [`<CodeBlock />` and `<InputForCodeBlock />` Components](https://design.chocolatey.org/code-block) to display a code block with variables that can be replaced with values from inputs.
